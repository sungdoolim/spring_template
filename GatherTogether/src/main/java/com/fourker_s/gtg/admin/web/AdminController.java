...
String id=request.getParameter("userId");
 ...
 model.addAttribute("name", name);
  ...
  loginService.deleteUser(vo);
	...
	@RequestMapping(value="/admin/adsearchBoard.do")//이주소가 오면 밑에 메서드 사용할 것 임
    ...
    //    String a=request.getParameter("userId");
  //      vo.setUserId(a);
        System.out.println("request : "+request.getParameter("bcontent"));
 System.out.println(bvo.getBcontent());
 
 
 List<BoardVO> bvolist = null;
 bvolist =adminService.searchBoard(bvo);
 
	model.addAttribute("all",bvolist);
 
		return "/admin/adsearchBoard";
    }
