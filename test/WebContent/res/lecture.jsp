...
<div class="container">
	<div class="row">
		<ul class="list-group">
			<a href="#" class="list-group-item active">1강</a>
			<a href="#" class="list-group-item">2강</a>
			<a href="#" class="list-group-item">3강</a>
			<a href="#" class="list-group-item">4강</a>
			<a href="#" class="list-group-item">5강</a>
		</ul>
	</div>
</div>
<div class="container">
<div class="row">
	<div class="embed-responsive embed-responsive-16by9">
		<iframe class="embed-responsive-item" src="https://www.youtube.com/embed/BErRLIIdbjE"></iframe>
